                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" id="form-filter" class="form-horizontal">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label for="Type of Waste" class="control-label">Dumpsite Names</label>
                                                    <select name="select_names" id="select_names" class="mul-select form-control" multiple="true">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="date" name="dateFrom" id="dateFrom" class="form-control form-control-sm" />
                                                </div>
                                                <div class="col-sm-4">
...
<script>
    $('#btnDate').click(function() {
        var select_name = $('#select_names').val();
...
<Script>
    $(document).ready(function() {
        ...
        $("#Page_title").text("Dumpsite Waste Monitoring");
        $("#b_crumb_subtitle").text("Barangay");
        $('#dump_nav').addClass("active");
...
<script>
    $(document).ready(function() {
        ...
        var datatable = $('#sample_table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= site_url('WasteDumpsite/table_data') ?>",
                "type": "POST",
                "data": function(data) {
        ...
        $('#btn-filter').click(function() { //button filter event click
            ...
            if (new Date(dateFrom) > new Date(dateTo)) {
                ...
                toastr.error('Dumpsite name field must not be empty!');
            } else {
                datatable.draw();
            }
