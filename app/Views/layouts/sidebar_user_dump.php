            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item" id="">
                    <a href="<?= site_url('dataEntryDump') ?>" class="nav-link" id="dashboardnav">
                        <i class="nav-icon fas fa-database"></i>
                        <p>Data Entry</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= site_url('reviewDump') ?>" class="nav-link" id="reviewDump">
                        <i class="fas fa-edit nav-icon"></i>
                        <p>Review</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= site_url('change_password_dumpsite') ?>" class="nav-link" role="" id="changepass_userD">
